...
################################################################################
## Form generated from reading UI file 'bld_MHRender.ui'
##
...
class Ui_wg_MHRender(object):
    def setupUi(self, wg_MHRender):
        if not wg_MHRender.objectName():
            wg_MHRender.setObjectName(u"wg_MHRender")
        wg_MHRender.resize(400, 1484)
        self.verticalLayout = QVBoxLayout(wg_MHRender)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.f_name = QWidget(wg_MHRender)
        ...
        self.gb_imageRender = QGroupBox(wg_MHRender)
        ...
        self.gb_submit = QGroupBox(wg_MHRender)
        ...
        self.gb_passes = QGroupBox(wg_MHRender)
        ...
        self.gb_previous = QGroupBox(wg_MHRender)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 349, 313))
        ...
        QWidget.setTabOrder(self.cb_format, self.gb_submit)
        ...
        self.retranslateUi(wg_MHRender)

        QMetaObject.connectSlotsByName(wg_MHRender)
    # setupUi

    def retranslateUi(self, wg_MHRender):
        wg_MHRender.setWindowTitle(QCoreApplication.translate("wg_MHRender", u"Image Render", None))
        self.l_name.setText(QCoreApplication.translate("wg_MHRender", u"Name:", None))
        self.l_class.setText(QCoreApplication.translate("wg_MHRender", u"MHImageRender", None))
        self.gb_imageRender.setTitle(QCoreApplication.translate("wg_MHRender", u"General", None))
        self.label_7.setText(QCoreApplication.translate("wg_MHRender", u"Context:", None))
        self.l_context.setText("")
        self.b_context.setText(QCoreApplication.translate("wg_MHRender", u"Select", None))
        self.label_2.setText(QCoreApplication.translate("wg_MHRender", u"Identifier:", None))
        self.l_taskName.setText("")
        self.b_changeTask.setText(QCoreApplication.translate("wg_MHRender", u"change", None))
        self.label_3.setText(QCoreApplication.translate("wg_MHRender", u"Framerange:", None))
        self.l_rangeEnd.setText(QCoreApplication.translate("wg_MHRender", u"1100", None))
        self.l_rangeStart.setText(QCoreApplication.translate("wg_MHRender", u"1001", None))
        self.l_rangeStartInfo.setText(QCoreApplication.translate("wg_MHRender", u"Start:", None))
        self.l_rangeEndInfo.setText(QCoreApplication.translate("wg_MHRender", u"End:", None))
        self.l_frameExpression.setText(QCoreApplication.translate("wg_MHRender", u"Frame expression:", None))
        self.label.setText(QCoreApplication.translate("wg_MHRender", u"Camera:", None))
        self.label_4.setText(QCoreApplication.translate("wg_MHRender", u"Resolution override:", None))
        self.chb_resOverride.setText("")
        self.b_resPresets.setText(QCoreApplication.translate("wg_MHRender", u"\u25bc", None))
        self.l_renderPreset.setText(QCoreApplication.translate("wg_MHRender", u"Rendersettings preset:", None))
        self.chb_renderPreset.setText("")
        self.l_outPath_2.setText(QCoreApplication.translate("wg_MHRender", u"Master Version:", None))
        self.l_outPath.setText(QCoreApplication.translate("wg_MHRender", u"Location:", None))
        self.label_5.setText(QCoreApplication.translate("wg_MHRender", u"Render layer:", None))
        self.label_6.setText(QCoreApplication.translate("wg_MHRender", u"Format:", None))
        self.gb_submit.setTitle(QCoreApplication.translate("wg_MHRender", u"Submit Render Job", None))
        self.l_manager.setText(QCoreApplication.translate("wg_MHRender", u"Manager:", None))
        self.l_rjPrio.setText(QCoreApplication.translate("wg_MHRender", u"Priority:", None))
        self.label_15.setText(QCoreApplication.translate("wg_MHRender", u"Frames per Task:", None))
        self.l_rjTimeout.setText(QCoreApplication.translate("wg_MHRender", u"Task Timeout (min)", None))
        self.label_18.setText(QCoreApplication.translate("wg_MHRender", u"Submit suspended:", None))
        self.chb_rjSuspended.setText("")
        self.label_19.setText(QCoreApplication.translate("wg_MHRender", u"Submit dependent files:", None))
        self.chb_osDependencies.setText("")
        self.label_16.setText(QCoreApplication.translate("wg_MHRender", u"Upload output:", None))
        self.chb_osUpload.setText("")
        self.label_17.setText(QCoreApplication.translate("wg_MHRender", u"Use Project Assets", None))
        self.chb_osPAssets.setText("")
        self.gb_osSlaves.setTitle(QCoreApplication.translate("wg_MHRender", u"Assign to slaves:", None))
        self.b_osSlaves.setText(QCoreApplication.translate("wg_MHRender", u"...", None))
        self.l_dlConcurrentTasks.setText(QCoreApplication.translate("wg_MHRender", u"Concurrent Tasks:", None))
        self.l_dlGPUpt.setText(QCoreApplication.translate("wg_MHRender", u"GPUs Per Task:", None))
        self.l_dlGPUdevices.setText(QCoreApplication.translate("wg_MHRender", u"Select GPU Devices:", None))
        self.le_dlGPUdevices.setPlaceholderText(QCoreApplication.translate("wg_MHRender", u"Enter Valid GPU Device Id(s)", None))
        self.gb_passes.setTitle(QCoreApplication.translate("wg_MHRender", u"Render Passes", None))
        self.b_addPasses.setText(QCoreApplication.translate("wg_MHRender", u"Add Passes", None))
        self.gb_previous.setTitle(QCoreApplication.translate("wg_MHRender", u"Previous render", None))
        self.l_pathLast.setText(QCoreApplication.translate("wg_MHRender", u"None", None))
        self.b_pathLast.setText(QCoreApplication.translate("wg_MHRender", u"...", None))
    # retranslateUi
