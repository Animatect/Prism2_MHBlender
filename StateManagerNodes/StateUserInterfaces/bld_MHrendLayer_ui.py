...
################################################################################
## Form generated from reading UI file 'bld_MHrendLayer.ui'
##
...
class Ui_wg_MHrendLayer(object):
    def setupUi(self, wg_MHrendLayer):
        ...
        self.f_name = QWidget(wg_MHrendLayer)
        ...
        self.gb_imageRender = QGroupBox(wg_MHrendLayer)
        ...
        self.gb_submit = QGroupBox(wg_MHrendLayer)
        ...
        self.retranslateUi(wg_MHrendLayer)

        QMetaObject.connectSlotsByName(wg_MHrendLayer)
    # setupUi

    def retranslateUi(self, wg_MHrendLayer):
        wg_MHrendLayer.setWindowTitle(QCoreApplication.translate("wg_MHrendLayer", u"Image Render", None))
        self.l_name.setText(QCoreApplication.translate("wg_MHrendLayer", u"Name:", None))
        self.l_class.setText(QCoreApplication.translate("wg_MHrendLayer", u"MHRenderLayerAdmin", None))
        self.gb_imageRender.setTitle(QCoreApplication.translate("wg_MHrendLayer", u"General", None))
        self.label_7.setText(QCoreApplication.translate("wg_MHrendLayer", u"Context:", None))
        self.l_context.setText("")
        self.b_context.setText(QCoreApplication.translate("wg_MHrendLayer", u"Select", None))
        self.label_2.setText(QCoreApplication.translate("wg_MHrendLayer", u"Identifier:", None))
        self.l_taskName.setText("")
        self.b_changeTask.setText(QCoreApplication.translate("wg_MHrendLayer", u"change", None))
        self.label_3.setText(QCoreApplication.translate("wg_MHrendLayer", u"Framerange:", None))
        self.l_rangeEnd.setText(QCoreApplication.translate("wg_MHrendLayer", u"1100", None))
        self.l_rangeStart.setText(QCoreApplication.translate("wg_MHrendLayer", u"1001", None))
        self.l_rangeStartInfo.setText(QCoreApplication.translate("wg_MHrendLayer", u"Start:", None))
        self.l_rangeEndInfo.setText(QCoreApplication.translate("wg_MHrendLayer", u"End:", None))
        self.l_frameExpression.setText(QCoreApplication.translate("wg_MHrendLayer", u"Frame expression:", None))
        self.label.setText(QCoreApplication.translate("wg_MHrendLayer", u"Camera:", None))
        self.label_4.setText(QCoreApplication.translate("wg_MHrendLayer", u"Resolution override:", None))
        self.chb_resOverride.setText("")
        self.b_resPresets.setText(QCoreApplication.translate("wg_MHrendLayer", u"\u25bc", None))
        self.l_renderPreset.setText(QCoreApplication.translate("wg_MHrendLayer", u"Rendersettings preset:", None))
        self.chb_renderPreset.setText("")
        self.l_outPath_2.setText(QCoreApplication.translate("wg_MHrendLayer", u"Master Version:", None))
        self.l_outPath.setText(QCoreApplication.translate("wg_MHrendLayer", u"Location:", None))
        self.label_5.setText(QCoreApplication.translate("wg_MHrendLayer", u"Render layer:", None))
        self.label_6.setText(QCoreApplication.translate("wg_MHrendLayer", u"Format:", None))
        self.gb_submit.setTitle(QCoreApplication.translate("wg_MHrendLayer", u"Submit Render Job", None))
        self.l_manager.setText(QCoreApplication.translate("wg_MHrendLayer", u"Manager:", None))
        self.l_rjPrio.setText(QCoreApplication.translate("wg_MHrendLayer", u"Priority:", None))
        self.label_15.setText(QCoreApplication.translate("wg_MHrendLayer", u"Frames per Task:", None))
        self.l_rjTimeout.setText(QCoreApplication.translate("wg_MHrendLayer", u"Task Timeout (min)", None))
        self.label_18.setText(QCoreApplication.translate("wg_MHrendLayer", u"Submit suspended:", None))
        self.chb_rjSuspended.setText("")
        self.label_19.setText(QCoreApplication.translate("wg_MHrendLayer", u"Submit dependent files:", None))
        self.chb_osDependencies.setText("")
        self.label_16.setText(QCoreApplication.translate("wg_MHrendLayer", u"Upload output:", None))
        self.chb_osUpload.setText("")
        self.label_17.setText(QCoreApplication.translate("wg_MHrendLayer", u"Use Project Assets", None))
        self.chb_osPAssets.setText("")
        self.gb_osSlaves.setTitle(QCoreApplication.translate("wg_MHrendLayer", u"Assign to slaves:", None))
        self.b_osSlaves.setText(QCoreApplication.translate("wg_MHrendLayer", u"...", None))
        self.l_dlConcurrentTasks.setText(QCoreApplication.translate("wg_MHrendLayer", u"Concurrent Tasks:", None))
        self.l_dlGPUpt.setText(QCoreApplication.translate("wg_MHrendLayer", u"GPUs Per Task:", None))
